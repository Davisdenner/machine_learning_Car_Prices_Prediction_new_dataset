...
<h2>💬Sobre</h2>
<p>Modelo de machine learning capaz de analisar e prever preços de carros utilizando regressão linear múltipla. O modelo conta com um aplicação web para visualização e análise dos dados.
</p>
